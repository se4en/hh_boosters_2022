...
def submit(experiment_name: str) -> None:
    ...
    model.load_state_dict(
        torch.load(
            os.path.join("outputs/", experiment_name, "model.pth"),
    ...
    preds.to_csv(
        os.path.join("outputs/", experiment_name, "submission.csv"),
        index=False,
        header=True,
    )
    probs.to_csv(
        os.path.join("outputs/", experiment_name, "probabilities.csv"),
        index=False,
        header=True,
    )
